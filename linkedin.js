...
// Validation Functionality
  var validator = $("#input_form").validate({
      ...
      errorPlacement: function (error, element) {
          ...
          if(inputName in errorMapper) {
            $(errorMapper[inputName]).before(error);
          }
      }
  });
  ...
  function checkIfVipCohortSelected() {
    if($('.vip_cohort[type="checkbox"]:checked').length === 0) {
        $('.vip_cohort_error_message').addClass('show');
        return false;
    } else {
        $('.vip_cohort_error_message').removeClass('show');
        return true;
    }
  }
...
// Form submission
  $('#submit_button').click(function () {
      ...
      var interested_cohort = $('input:checkbox:checked.vip_cohort').map(function () {
        return this.value;
      }).get();
      ...
      var personDataObject = {
          person: {
              ...
              vip_industry_list: interested_cohort,
              bio: bio,
      ...
      if (checkIfVipCohortSelected() && $('#input_form').valid()) {
  ...
  function processLinkedInData() {
      ...
      if (auth_code !== null) {
        ...
        let redirectUrl = "https://innovationlabs.harvard.edu/judge-form/?role=judge"
        if(globalToken) {
  ...
  $("#linkedin").click(function (e) {
      ...
      let redirectUrlRoot = "https://innovationlabs.harvard.edu/judge-form/?role=judge"
      let redirectUrl = '';
      if (globalToken) {
